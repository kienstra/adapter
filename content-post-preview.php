...
<article <?php esc_attr( post_class( 'post-preview' ) ); ?>>
	...
	<p>
		...
		<a href="<?php esc_url( get_the_permalink() ); ?>" class="mobile-post-permalink">
	<span class="glyphicon glyphicon-chevron-right"></span>
		</a>
	</p>
	<p>
		<?php echo get_the_excerpt(); ?>
		<a class="pull-right btn btn-primary btn-med read-more-button" href="<?php esc_url( get_the_permalink() ); ?>">
